    ...
    <>
      ...
      >
        ...
        <form onSubmit={(e) => {
            ...
            <div className="md:flex md:items-center mb-6">
                ...
                <div className="md:w-2/3">
                    ...
                    type="text" 
                    value={img}
                    onChange={(e) => {setImg(e.target.value)}/*this will get the value from the text box*/}/>
                </div>
            </div>
        </form>
        </Modal.Body>
        ...
        <Modal.Footer>
            ...
            <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" form='editmodal' onClick={handleClose}>Add Employee</button>
        </Modal.Footer>
